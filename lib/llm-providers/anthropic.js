 ...
 */
export async function* sendMessageStream({ apiKey, model, prompt, history, systemInstruction, temperature, maxTokens, images }) {
  ...
  // Build current user message — multimodal content blocks if images are attached
  ...
  try {
    ...
    const stream = await client.messages.create({
      ...
      max_tokens: maxTokens ? maxTokens : maxTokensDefault
